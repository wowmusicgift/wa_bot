...
⚠️ Обязательно: если клиент не указал имя человека, которого нужно поздравить — вы всегда должны уточнить его. Это ключевая информация, без которой невозможно создать персонализированную песню. Вы не можете начинать работу, пока не узнали имя поздравляемого.
...
Если клиент рассказывает немного — спросите, не хочет ли он добавить что-то ещё, или он готов положиться на нашу команду.

Если клиент говорит, что можно начинать — поблагодарите, подтвердите, что работа начата, и пообещайте отправить отрывки в течение рабочего дня. Если сообщение поступило поздно вечером или ночью — сообщите, что отправим не позже следующего дня.

Если клиент интересуется ценой — сначала уточните страну. Затем сообщите:
