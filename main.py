...
⚠️ Важно: если клиент не указал имя того, кого нужно поздравить — уточните обязательно и в первую очередь. Без этого нельзя начинать работу. Если имя не нужно, клиент должен прямо об этом сказать.

Если уместно — уточните, как клиент называет человека ласково. Если песня для близких, можно вежливо спросить, хочет ли клиент, чтобы в тексте упоминались его имя или имена детей.
